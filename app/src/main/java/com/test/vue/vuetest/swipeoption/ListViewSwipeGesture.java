package com.test.vue.vuetest.swipeoption;
...
public class ListViewSwipeGesture implements OnTouchListener {
    ...
    private void GetResourcesValues() {
        ...
        HalfDrawable        =   activity.getResources().getDrawable( R.drawable.ic_action_dropdown );
        FullDrawable        =   activity.getResources().getDrawable(R.drawable.ic_action_arrow);
    }
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    if (rect.contains(x, y)) {
                        ...
                        mDownView           =   (ViewGroup) child.findViewById(R.id.list_lay_id);
